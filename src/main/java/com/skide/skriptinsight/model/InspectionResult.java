...
public class InspectionResult {
    ...
    public long getTimeTakenToParse() { return timeTakenToParse; }
    @JsonProperty("TimeTakenToParse")
    public void setTimeTakenToParse(long value) { this.timeTakenToParse = value; }

    @JsonProperty("TimeTakenToFix")
    public long getTimeTakenToFix() { return timeTakenToFix; }
    @JsonProperty("TimeTakenToFix")
    public void setTimeTakenToFix(long value) { this.timeTakenToFix = value; }
}