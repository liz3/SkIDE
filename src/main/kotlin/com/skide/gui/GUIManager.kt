...
object GUIManager{
    ...
    fun getWindow(fxFilePath: String, name: String, show: Boolean, stage: Stage = Stage()): ActiveWindow{
        ...
        //Possibly need to consider .ico files
    ...
    fun showAbout(){
        ...
        view.engine.loadWorker.stateProperty().addListener{ _, _, newValue ->
            if (newValue === State.SUCCEEDED){
                ...
                Prompts.infoCheck("Attention", "re-open if links don't work!", "If you want to open a link, but it does not work, restart about!", Alert.AlertType.INFORMATION)
            }
        }
